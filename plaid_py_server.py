...
def transfer_authorization():
    try:
        ...
        print(f"Incoming authorization request data: {data}")  # Debug print
        ...
        try:
            ...
            print(f"Using account ID: {account_id}")  # Debug print
        except Exception as e:
        ...
        try:
            ...
            response = client.transfer_authorization_create(auth_request)
            pretty_print_response(response.to_dict())
...
def transfer():
    try:
        ...
        if not authorization_id:
            return jsonify({'error': 'Missing authorization_id'}), 400
        if not account_id:
        ...
        try:
            transfer_request = TransferCreateRequest(
                ...
                account_id=account_id,  # Now including the required account_id
